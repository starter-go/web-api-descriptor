module github.com/bitwormhole/web-api-descriptor

go 1.18

require github.com/starter-go/module-security-gin-gorm v0.0.1
...
require (
	...
	github.com/starter-go/application v0.9.12 // indirect
	github.com/starter-go/base v0.9.7 // indirect
	github.com/starter-go/configen v0.9.2 // indirect
	github.com/starter-go/libgin v1.0.4 // indirect
	...
	github.com/starter-go/module-gorm-sqlserver v0.9.0 // indirect
	github.com/starter-go/security v1.0.19 // indirect
